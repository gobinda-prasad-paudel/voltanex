...
import { siteConfig, navigationLinks } from "@/lib/data"
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <p className="mt-4 text-gray-400">Pioneering embedded systems and AI solutions for a smarter future.</p>
          </div>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li>United States</li>
              <li className="pt-2">{siteConfig.contactEmail}</li>
